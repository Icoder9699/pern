...
export default memo(function DropdownMenu(props: IProps) {
  const location = useLocation();
  return (
    <div className={cls.menu}>
      <div
        className={classNames(cls.menu__title, {
          [cls.menu__title_open]: !props.isOpen,
        })}
      ...
      {props.selectedMenuId === props.index && (
        <ul
          className={classNames(cls.menu__submenus, {
            [cls.menu__submenus_tiny]: !props.isOpen,
          })}
        >
            ...
            return (
              <li
                className={classNames(cls.submenu, {
                  [cls.active]: location.pathname === `/${submenu.path}`,
                })}
                key={idx}
              >
